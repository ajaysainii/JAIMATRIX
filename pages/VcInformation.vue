<template>
  <div class="px-0 my-5 d-flex justify-content-center align-item-center">
    <div class="companyinfo-form container-fluid">
      <form class="row mx-auto">
        <div class="formcontainer col-lg-10 px-5">
          <div class="mb-5">
          ...
          <div class="row mx-auto">
            ...
            <div class="form-group col-lg-4 col-md-6 col-12 mb-3">
              ...
              <input type="text" id="Location" name="Location" placeholder="Location" v-model="companyData.location" />
          ...
          <div class="d-flex mt-4 justify-content-between w-100 align-items-center companyinfo flex-wrap">
            <CancelModal v-if="modalOpen" @close="closeModal" />

            <button @click="modelopen" v-if="!this.$route.query.id" type="button" class="submit-draft">
              Cancel
            </button>
            <button type="button" @click="VentureCompanyinfo" v-if="!this.$route.query.id"
              class="submit-btn">
              <span v-if="!isLoading">Save</span>
              <span v-else class="loader"></span>
              </button>
            <button @click="updateCompanyInfo" v-if="this.$route.query.id" type="button" class="submit-btn">
              Update
            </button>
          </div>
          <div>
