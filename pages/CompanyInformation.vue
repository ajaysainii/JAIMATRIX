  ...
  <div class="px-0 mb-5 d-flex justify-content-center align-item-center">
    <div class="companyinfo-form container-fluid px-0">
      <div class="company-header">
        <h1 class="my-2">Company Information</h1>
      </div>
        ...
        <div class="formcontainer col-lg-12">
          ...
          <div class="row mx-auto">
            ...
            <div class="form-group col-lg-12 col-md-12 col-12 mb-3">
              ...
              <input type="text" id="location" name="location" placeholder="Enter company address"
          ...
          <div class="d-flex my-4 justify-content-end align-items-center companyinfo">
            ...
            <button @click="Projectinfo" v-if="!this.$route.query.id" type="button" class="submit-btn">
