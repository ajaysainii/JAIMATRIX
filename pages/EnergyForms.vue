              ...
              <b-tab :activeTab="0">
                ...
                <form>
                  <div class="row mx-auto p-4">
                    ...
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Energy Type </label>
                      <input type="text" id="Energy Type" name="Energy Type" placeholder="Energy Type"
                        v-model="json_data.energy_type" />
                      <!-- <span v-if="energyTypeError" class="error-message">{{
                        energyTypeError
                      }}</span> -->

                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Capacity <small>(in MW)</small> </label>
                      <input type="text" id="Capacity" name="Capacity" placeholder="Capacity"
                        v-model="json_data.capacity" />
                      <!-- <span v-if="capacityError" class="error-message">{{
                        capacityError
                      }}</span> -->
                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Power sources</label>
                      <input type="text" id="Power sources" name="Power sources" placeholder="Power sources"
                        v-model="json_data.power_sources" />
                      <!-- <span v-if="powersourceError" class="error-message">{{
                        powersourceError
                      }}</span> -->
                    </div>
                    ...
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      ...
                      <select class="form-select" aria-label="Default select example" v-model="json_data.brown_green">
                        <option value="Select Brown/Green Field" selected>
                          Select Brown/Green Field
                        </option>
                    ...
                    <div class="form-group col-xl-5 col-lg-5 col-md-6 col-12 mb-3">
                    ...
                    <div class="form-group col-xl-4 col-lg-4 col-md-6 col-12 mb-3">
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-12 col-12 mb-3">
                      <label for="location">Valuation applicable for the below deal
                    ...
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Preffered Interest rate</label>
                      <input type="text" id="Interest rate" placeholder="Interest rate" name="Interest rate"
                    ...
                    <div class="form-group col-xl-9 col-lg-9 col-md-6 col-12 mb-3">
                      ...
                      <input type="text" id="Exit strategy" name="Exit strategy" placeholder="Exit strategy"
                        v-model="json_data.texit_strategy" required />
                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
              ...
              <b-tab :activeTab="1">
                ...
                <form>
                  <div class="row mx-auto p-4" :content="tab2Content">
                    ...
                    <div class="form-group col-xl-9 col-lg-9 col-md-12 col-12 mb-3">
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12 mb-3">
                      <label for="website">Brief slogan (up to 10 words)</label>
      ...
      var response = await this.$store.dispatch('retriveProjectProfile' , id)
          if(response) {
                ...
                if (projectProfile) {
                  ...
                  this.json_data.energy_type = json_data.energy_type
                  this.json_data.capacity = json_data.capacity
                  this.json_data.power_sources = json_data.power_sources
