  ...
  <div class="px-0 d-flex justify-content-center align-item-center forms">
    <div class="companyinfo-form container-fluid px-0">
      <div class="company-header">
        <h1 v-if="json_data.project_name" class="my-2">{{ json_data.project_name }}</h1>
      </div>
              ...
              <b-tab :activeTab="0">  
                ...
                <form>
                  <div class="row mx-auto p-4">
                    ...
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="form-select">Brown/Green Field</label>
                      <select class="form-select" aria-label="Default select example" v-model="json_data.brown_green">
                        <option selected value="Select Brown/Green Field">Select Brown/Green Field</option>
                        <option value="Brown">Brown</option>
                        <option value="Green">Green</option>
                        <option value="Other">Other</option>
                      </select>
                      <!-- <span v-if="brownGreenerrorMessage" class="error-message">{{
                        brownGreenerrorMessage
                      }}</span> -->
                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Project Location</label>
                      <input type="text" id="location" name="location" placeholder="Project Location"
                        v-model="json_data.project_location" required />
                      <!-- <span v-if="LocationerrorMessage" class="error-message">{{
                        LocationerrorMessage
                      }}</span> -->
                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="foundation_year">Project Cost <small>(Mil $)</small>
                      </label>
                      <input type="text" id="Project Cost" placeholder="Project Cost" name="Project Cost"
                        v-model="json_data.project_cost" required />

                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="Total Funding">Total Funding Requirements</label>
                    ...
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Pre-Money Valuation <small>(Mil$)</small></label>
                      <input type="number" id="Valuation" name="Valuation" placeholder="Pre-Money Valuation"
                        v-model="json_data.deal" required />

                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Post-Money Valuation <small>(Mil$)</small></label>
                      <input type="number" id="Valuation" name="Valuation" placeholder="Post-Money Valuation"
                        v-model="json_data.post_money" required />

                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Pre-Money Multiples <small>(i.g. 2XSALES, 3.5xEBIT, 20xEBIT)</small></label>
                      <input type="text" id="money multiplies" name="money multiplies"
                        placeholder="Pre-Money Multiples" v-model="json_data.money_multiples" required />

                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="Debt Funding">Debt Funding <small>(Mil $)</small>
                      </label>
                      <input type="number" id="Debt Funding" placeholder="Debt Funding" name="Debt Funding"
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-12 col-12 mb-3">
                      <label for="location">Project Credit Rating & Rating Company</label>
                      <input type="text" id="Rating Company" placeholder="Name" name="Rating Company"
                        v-model="json_data.rating_company" required />

                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Project start year.</label>
                      <input type="month" id="start year" placeholder="start year" name="start year"
                        v-model="json_data.start_year" required />
                    </div>


                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-12 mb-3">
                      <label for="location">Commissioning date</label>
                      <input type="date" id="Commissioning date" placeholder="Commissioning date"
                        name="Commissioning date" v-model="json_data.commissioning_date" required />
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12 mb-3">
                      ...
                      <input type="text" id="Purpose" name="Purpose" placeholder="Purpose" v-model="json_data.purpose"
                        required />
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-12 col-12 mb-3">
                      ...
                      <input type="text" id="Deal Status" name="Deal Status" placeholder="Deal Status" maxlength="50"
                        v-model="json_data.status_deal" required />

                    </div>
                    <div class="form-group col-xl-12 col-lg-12 col-md-6 col-12 mb-3">
                      <label for="Exit strategy">Exit strategy <small>(20-30 words)</small>
                      </label>
                      <textarea name="Exit strategy" id="Exit strategy" rows="2" cols="5"
                        v-model="json_data.texit_strategy"></textarea>
                    </div>
                ...
                <form>
                  <div class="row mx-auto p-4" :content="tab2Content">
                    <div class="form-group col-xl-12 col-lg-12 col-md-12 col-12 mb-3">
                      ...
                      <textarea name="Business Model" id="Business Model" rows="2" cols="5"
                        v-model="json_data.business_model"></textarea>
                    </div>
                    <div class="form-group col-xl-12 col-lg-13 col-md-13 col-12 mb-3">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-12 ">
                      <TagifyInput label="Industry Served" :settings="{ whitelist: json_data.industry_served }"
                    ...
                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12 mb-3">
                      ...
                      <textarea name="Brief slogan" id="Brief slogan" rows="2" cols="5"
                        v-model="json_data.brief_slogan"></textarea>
                    </div>
                    <div class="form-group col-xl-6 col-lg-6 col-md-6 col-12 mb-3">
                      <label for="foundation_year">Brief USP <small>(up to 10 words)</small>
                      </label>
                      <textarea name="Brief USP" id="Brief USP" rows="2" cols="5"
                        v-model="json_data.brief_USP"></textarea>
                ...
                <form>
                  <div class="row mx-auto p-4" :content="tab2Content">
                    ...
                    <div class="form-group col-xl-9 col-lg-9 col-md-6 col-12 mb-3">
                      <label for="Brief Background">Brief Background <small>(up to 10 words)</small></label>
                      <input type="text" id="Brief Background" placeholder="Brief Background" name="Brief Background"
                        minlength="50" v-model="json_data.brief_background_six" />

                    </div>
                    <div class="form-group col-xl-3 col-lg-3 col-md-6 col-6 mb-3">
                      <label for="name">Number of Employees</label>
                      <input type="number" id="Employees" placeholder="00000" pattern="[0-9]" name="Employees"
                        v-model="json_data.number_of_employees" required @input="handleInput" />
                    ...
                    <input hidden type="text" id="Comments" placeholder="Comments if any" name="Comments" minlength="50"
      ...
      <CancelModal v-if="cancelData && isVisible" @close="closeModal" />
    </div>
  </div>
</template>
  ...
  async fetch() {
    ...
    if (this.$route.query.id) {
      ...
      if (projectProfile) {
        ...
        this.json_data.project_cost = json_data.project_cost
        ...
        this.json_data.post_money = json_data.post_money
        this.json_data.money_multiples = json_data.money_multiples
        //Account details
        ...
        this.json_data.status_deal = json_data.status_deal
